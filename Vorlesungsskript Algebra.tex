...
\renewcommand{\thesectiontwo}{\arabic{chapter}.\arabic{section}}
...
\renewcommand{\lecture}{\stepcounter{lecture} \index[file]{Datei \thelecture} \marginnote{Datei \thelecture}}
\makeindex[name=file,title=Dateien,intoc]
